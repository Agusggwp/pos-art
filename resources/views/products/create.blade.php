...
<div class="max-w-2xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <form class="p-6 space-y-6" action="{{ route('products.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-1">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input id="name" type="text" name="name" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md placeholder-gray-500 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm bg-white text-gray-900 transition-all duration-200 @error('name') border-danger focus:border-danger @enderror" value="{{ old('name') }}" required autocomplete="name" placeholder="Nama produk">
                </div>
                @error('name')
            ...
            <div class="space-y-1">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input id="price" type="number" name="price" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md placeholder-gray-500 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm bg-white text-gray-900 transition-all duration-200 @error('price') border-danger focus:border-danger @enderror" value="{{ old('price') }}" min="0" required autocomplete="price" placeholder="0">
                </div>
                @error('price')
                    <p class="mt-2 text-sm text-danger flex items-center space-x-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Stok -->
            <div class="space-y-1">
                <label for="stock" class="block text-sm font-medium text-gray-700">Stok Awal <span class="text-danger">*</span></label>
                <div class="relative rounded-md shadow-sm">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none mt-1">
                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input id="stock" type="number" name="stock" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md placeholder-gray-500 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm bg-white text-gray-900 transition-all duration-200 @error('stock') border-danger focus:border-danger @enderror" value="{{ old('stock') }}" min="0" required autocomplete="stock" placeholder="0">
                </div>
                @error('stock')
                    <p class="mt-2 text-sm text-danger flex items-center space-x-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-1">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input id="barcode" type="text" name="barcode" class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-md placeholder-gray-500 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm bg-white text-gray-900 transition-all duration-200 @error('barcode') border-danger focus:border-danger @enderror" value="{{ old('barcode') }}" autocomplete="barcode" placeholder="Contoh: 1234567890">
                </div>
                @error('barcode')
                    <p class="mt-2 text-sm text-danger flex items-center space-x-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
